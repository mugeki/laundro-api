...
func (_m *Repository) GetAllByLaundromat(laundroID uint) ([]products.Domain, error) {
...
// GetByCategoryName provides a mock function with given fields: categoryName
func (_m *Repository) GetByCategoryName(categoryName string) (products.Domain, error) {
...
// GetCategoryID provides a mock function with given fields: name
func (_m *Repository) GetCategoryID(name string) (int, error) {
	ret := _m.Called(name)
...
// GetCategoryNameByProductID provides a mock function with given fields: id
func (_m *Repository) GetCategoryNameByProductID(id uint) string {
	ret := _m.Called(id)
...
func (_m *Repository) GetLaundromatByCategory(categoryId int) ([]laundromats.Domain, error) {
...
func (_m *Repository) GetLaundromatID(id uint) uint {
	ret := _m.Called(id)
...
// Insert provides a mock function with given fields: productData
func (_m *Repository) Insert(productData *products.Domain) (products.Domain, error) {
	ret := _m.Called(productData)
...
func (_m *Repository) Update(id uint, productData *products.Domain) (products.Domain, error) {
